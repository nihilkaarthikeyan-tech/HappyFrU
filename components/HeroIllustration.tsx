...
export default function HeroIllustration() {
  return (
    <div className="relative mx-auto w-full max-w-md aspect-square">
      <div className="absolute inset-0 rounded-[2.5rem] bg-brand-navy rotate-3" />
      <div className="absolute inset-0 rounded-[2.5rem] bg-brand-navy-light -rotate-2 opacity-60" />

      <div className="absolute inset-6 rounded-[2rem] bg-brand-navy-dark shadow-xl flex items-center justify-center p-5">
        <div className="w-full aspect-[4/3] rounded-xl bg-brand-yellow flex flex-col items-center justify-center gap-2 relative overflow-hidden">
          ...
          <PlayCircle className="mt-3 text-brand-navy/80" size={36} />
      ...
      <div className="absolute -bottom-4 -left-4 rounded-2xl bg-white shadow-lg px-4 py-3 text-xs font-semibold text-brand-navy border border-black/5">
        720+ daily views / screen
      </div>
      <div className="absolute -top-4 -right-2 rounded-2xl bg-white shadow-lg px-4 py-3 text-xs font-semibold text-brand-navy border border-black/5">
        95% ad completion
      </div>
    </div>
  );
